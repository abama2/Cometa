...
alert-level-arma = Армагедон
alert-level-arma-announcement = Центральное командование объявило о признание станции врагом NT, все контракты расторгнуты, прощайте.
alert-level-arma-instructions = Все контракты расторгнуты.
alert-level-beta = Бета
alert-level-beta-announcement = На станции присутствует неизвесная угроза повышенного уровня опасности, Служба Безопасности должна всегда держать оружие на готове, весь экипаж обязан спрятатся в своих отделах до устронения угрозы.
alert-level-beta-instructions = Гражданский персонал обязан немедленно обратиться к главам отделов для получения указаний к эвакуации. Корпорация Nanotrasen заверяет вас - опасность скоро будет нейтрализована.